...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			EfficientDocument efficientDocument = new EfficientDocument(chars);
			BasicDocument basicDocument = new BasicDocument(chars);
			
			double startEfficient = System.nanoTime();
			efficientDocument.getFleschScore();
			double finishEfficient = System.nanoTime();
			 
			double startBasic = System.nanoTime();
			basicDocument.getFleschScore();
			double finishBasic = System.nanoTime();
			 
			double efficientTime = (finishEfficient - startEfficient) / 1000000000;
			double basicTime = (finishBasic - startBasic) / 1000000000;
